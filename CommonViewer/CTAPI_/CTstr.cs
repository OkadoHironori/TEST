    ...
    public class CTstr
    {
        ...
        public struct INFDEF
        {
            ...
            public void Initialize()
            {
                ...
                xfocus_c = FixedString.CreateArray<FixedString8>(2);        // 'X線焦点(0)小(1)大      'v18.00追加 byやまおか 2011/03/15_変更2014/07/16hata_v19.51反映
        ...
        public struct SCANCONDPAR
        {
            ...
            public void Initialize()
            {
                ...
                detector_pitch = new float[3];              // ii視野別の検出器ピッチ						REV9.6 追加 2004-10-20 by 間々田 
