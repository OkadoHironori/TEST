...
namespace CTAPI
{
    ...
    public class Pulsar
    {
        ...
        /// <summary>
        /// 純生データ保存 //Rev23.12 追加 by長野 2015/12/11
        /// </summary>
        /// <param name="WordImage"></param>
        /// <param name="h_size"></param>
        /// <param name="v_size"></param>
        [DllImport("Pulsar.dll")]
        public static extern void SavePurData(
            ushort[] WordImage,	//純生データ
            string fileName,    //純生データファイル名
            int size			//サイズ(縦*横)
        );
        ...
        public static extern int Mil9AddComment(IntPtr hMil, int sizeX, int sizeY, int posx, int posy, int size, int color, string str1, string str2, string str3, string str4, ref byte tmpWordImage,int marginPix);

        //Rev22.00 追加 by長野 2015/07/03
        [DllImport("Pulsar.dll", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
        public static extern int Mil9AddCommentInit(int FontSize, int FontColor);
