...
namespace CT30K.Common
{
    public sealed class AppValue
    {
        ...
        /// <summary>
        /// 画質ボタン用ファイルパス Rev26.00 add by chouno 2016/12/28
        /// </summary>
        public static readonly string PathScanCondFile;

        /// <summary>
        /// 画質ボタン プリセット用ファイルパス Rev26.00 add by chouno 2017/09/01
        /// </summary>
        public static readonly string PathScanCondPresetFile;
        ...
        /// <summary>
        /// スキャン、再構成進捗表示用実行ファイル //Rev26.00 add by chouno 2017/03/13
        /// </summary>
        public static readonly string RECIUDP;
        ...
        /// <summary>
        /// CT30K 処理系パラメータ用iniファイル //Rev26.00 追加 by長野 2016/12/27
        /// コモンに持たせるほどではないが、設定ファイルとしては持っておく必要のある処理系パラメータ
        /// </summary>
        public static readonly string CT30KProcessParaIniFileName;

        /// <summary>
        /// CT30K UI系パラメータ用iniファイル //Rev26.00 add by chouno 2017/01/19
        /// コモンに持たせるほどではないが、設定ファイルとして持っておく必要のあるUI系パラメータ
        /// </summary>
        public static readonly string CT30KUIParaIniFileName;

        /// <summary>
        /// XrayAutoVI用iniファイル  //Rev26.00 追加 by Hata 2017/02/01
        /// </summary>
        public static readonly string XrayAutoVIIniFileName;
...
//#endif
            ...
            PathScanCondFile = Path.Combine(PathSetFile,@"ScanCond") + "\\";
            PathScanCondPresetFile = Path.Combine(PathScanCondFile, @"Preset") + "\\";
            ...
            RECIUDP = Path.Combine(pathCommand, @"ReciUDP.exe");
            ...
            //Rev26.00 追加 by長野 2016/12/27
            CT30KProcessParaIniFileName = Path.Combine(CTPATH, @"ini\CT30KProcessPara.ini");

            CT30KUIParaIniFileName = Path.Combine(CTPATH, @"ini\CT30KUIPara.ini");

            // PKE用
            XisIniFileName = @"C:\XIS\Program\xis.ini";

            //Rev26.00 追加 by Hata 2017/02/01
            // XrayAutoVI　iniファイル
            XrayAutoVIIniFileName = Path.Combine(CTPATH, @"ini\XrayAutoVI.ini");
