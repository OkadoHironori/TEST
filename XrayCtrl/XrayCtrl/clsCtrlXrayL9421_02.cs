...
namespace XrayCtrl
{
	...
	//   2010/05/11  1.00        (KS1)Hata
	//
	//***********************************************************************************
	internal class clsCtrlXrayL9421_02 : IDisposable
	{
...
//10/05/12削除L9421-02対応
		//Private Const P_SOV                 As Integer = 6                  ' 過負荷保護機能確認
		//Private Const P_STX                 As Integer = 1                  ' X線照射確認
...
//10/05/12追加L9421-02対応
		...
		//----- ステータスコマンド -----
//10/05/12削除L9421-02対応
		//Private Const CTRL_STX               As String = "STX"              ' X線照射確認
		//Private Const CTRL_SOV               As String = "SOV"              ' 過負荷保護機能確認
...
*/
                    ...
                    //ModuleCTRLM.ipX_type = 5;		//X線ﾀｲﾌﾟ(L9421_02)
