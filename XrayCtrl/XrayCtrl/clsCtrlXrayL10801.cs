...
namespace XrayCtrl
{
	...
	//   2009/08/19  1.00        (KSS)Hata
	//
	//***********************************************************************************
	internal class clsCtrlXrayL10801 : IDisposable
	{
...
//		private bool mblnGetType;				//X線タイプ取得済フラグ
		...
		private const int P_SHS = 28;					// フィラメント設定電圧確認
		...
		private const int P_MAX = 33;					// コマンド数    'v15.10変更 byやまおか 2009/11/12
...
//2009/08/21_未使用_hata
		...
		private const string CTRL_SHS = "SHS";			// フィラメント設定電圧確認
		...
		private const int mcintMaxOBJ = 23000;			//ﾌｫｰｶｽ値 最大値
		private const int mcintMinOBJ = 0;				//ﾌｫｰｶｽ値 最小値
		private const int mcintMaxOBX = 1200;			//X方向ｱﾗｲﾒﾝﾄ 最大値
		private const int mcintMinOBX = -1200;			//X方向ｱﾗｲﾒﾝﾄ 最小値
		private const int mcintMaxOBY = 1200;			//Y方向ｱﾗｲﾒﾝﾄ 最大値
		private const int mcintMinOBY = -1200;			//Y方向ｱﾗｲﾒﾝﾄ 最小値
...
*/
				...
				if (modData.gintXrayClsCnt == 0)
				{
                    ...
                    //Rev23.10 ポート番号の設定を追加 by長野 2015/09/29
...
*/
                    ...
                    //ModuleCTRLM.ipX_type = 3;		//X線ﾀｲﾌﾟ(230kV)
                    ModuleCTRLM.ipX_type = modIniFiles.XRAY_TYPE_NO_230KV;
