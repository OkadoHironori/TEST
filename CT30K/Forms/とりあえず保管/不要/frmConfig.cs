...
//			With scaninh
				...
				var scaninh = modScaninh.scaninh;
...
//			End With
			...
			t20kinf.system_type = Convert.ToString(modLibrary.GetOption(optXrayTypes));
...
//			End With
			...
			//Ｘ線のタイプ       'v11.3追加 by 間々田 2006/02/03
			modLibrary.SetOption(optXrayType, Val(t20kinf.system_type));
        
			//検出器の種類       'v17.00追加 byやまおか 2010/01/19
			modLibrary.SetOption(optDetType, Val(scancondpar.detector));
