...
//			With lblStatus
            ...
            else if (lblStatus.Text == CTResources.LoadResString(12363) || lblStatus.Text == CTResources.LoadResString(12364))
			{
            ...
            else if (lblStatus.Text == CTResources.LoadResString(12114))
			{
            ...
            else if (lblStatus.Text == StringTable.GC_STS_WAITCAPTURE)
            {
                lblStatus.BackColor = Color.Red;	    //データ収集待ち 'v18.00追加 byやまおか 2011/07/03 'v19.50 v19.41とv18.02の統合 by長野 2013/11/05　追加2014/10/07hata_v19.51反映
            }
            ...
            else if (lblStatus.Text == StringTable.GC_STS_REMOTE)
            {
                lblStatus.BackColor = Color.Red;		// '外部制御       'v18.00追加 byやまおか 2011/03/06 'v19.50 v19.41とv18.02の統合 by長野 2013/11/05
            }
            else if (lblStatus.Text == StringTable.GC_STS_MANUAL)
            {
                lblStatus.BackColor = Color.Red;		//手動           'v18.00追加 byやまおか 2011/03/06 'v19.50 v19.41とv18.02の統合 by長野 2013/11/05
            }
		...
		private void UserControl_Initialize()
		{
            ...
            lblCaption.Text = CTResources.LoadResString(StringTable.IDS_Status);
            lblColon.Text = CTResources.LoadResString(StringTable.IDS_Colon);
		}
