...
namespace CT30K
{
    ...
    internal static class StringTable
	{
        ...
        public const int IDS_PurRawData = 12095;            //純生データ Rev23.12 追加 by長野 2015/12/11
        ...
        public const int IDS_DropTestMode = 26031;          //高速(落下試験器) add by chouno 2019/02/12
        ...
        public const int IDS_W_Scan = 25001;                //Wスキャン      'v25.00追加 by長野     2016/07/05 
        public const int IDS_W_ScanConflictScanInhibit = 25002;     //Wスキャン関連でscaninhibitの競合 byRev25.00 追加 by長野 2016/07/07

        //追加 ここから　by長野 Rev23.10 2015/09/20
        public const int IDS_MicroFpdPos = 23002;
        public const int IDS_MicroFpdShiftPos = 23003;
        public const int IDS_NanoFpdPos = 23004;
        public const int IDS_NanoFpdShiftPos = 23005;
        public const int IDS_MicroFpdBusy = 23006;
        public const int IDS_MicroFpdShiftBusy = 23007;
        public const int IDS_NanoFpdBusy = 23008;
        public const int IDS_NanoFpdShiftBusy = 23009;
        public const int IDS_UnknownFpdPos = 23010;
        public const int IDS_OkXrayFpdMove = 23011;
        //追加 ここまで　by長野 Rev23.10 2015/09/20
        ...
        public static string GC_STS_FLM_NG;             //フィラメント異常  'v23.10追加 by長野 2015/10/06 

        //v19.00 ->（電S2）永井
        //BHC関連定数
        public const int IDS_BHCTable = 21000;
        public const int IDS_BHCTableDir = 21001;		    //CTUSER\BHCﾃｰﾌﾞﾙ
        public const int IDS_BHC = 21003;		            //BHC                      'v26.00追加　by井上 2017/01/18
        public const int IDS_BHCFile = 21005;		        //BHCファイル
        public const int IDS_BHCImageDir = 21006;		    //CTUSER\画像
        public const int IDS_BHCConflict = 21010;           //BHC競合エラーメッセージ　'v26.00追加　by井上 2017/01/18
        ...
        public const int IDS_Scano = 12027;                 //スキャノ
        public const int IDS_ScanoCondition = 22000;        //スキャノ条件詳細
        public const int IDS_ScanoPitch = 22001;            //スキャノピッチ
        public const int IDS_ScanoWidth = 22002;            //スキャノ厚
        public const int IDS_ScanoDataRange = 22003;        //スキャノデータ収集範囲
        //Rev21.00 追加 by長野 2015/02/19 <-
		...
		public static void SetConstString()
		{
            ...
            GC_STS_FLM_NG = CTResources.LoadResString(23018);               //フィラメント異常   v23.10 追加 by長野 2015/10/06
            ...
            switch (modXrayControl.XrayType)
            {
                ...
                case modXrayControl.XrayTypeConstants.XrayTypeSpellman: //Rev25.03/Rev25.02 add by chouno 2017/02/05
