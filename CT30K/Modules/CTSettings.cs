...
namespace CT30K
{
    public static class CTSettings
    {
        ...
        public static Roikey roikey;                    //追加2015/02/05 //Rev20.00 追加 by長野
        ...
        /// <summary>
        /// ラージテーブル用 リング幅(mm) //Rev25.10 add by chouno 2017/09/11
        /// </summary>
        public static float GVal_LargeTableRingWidth;
        ...
        /// FDD側の限界値(FDD-FCD
        /// </summary>
        public static float Gval_BetMaxFcdAndFdd;   //v23.30 追加 by長野 検出器側に最も寄せた場合の検出器とテーブルの間隔 (仕様書上の最大FDD-最大FCD)
...
*/
        ...
        /// <summary>
        /// X線切替機能(外部制御有版) (True:有, False:無)  'v23.10 追加 by 長野 15-09-18
        /// </summary>
        public static bool ChangeXrayOn;
        ...
        //Wスキャンスキャン（True:有，False:無)            'v25.00追加 by長野     2016/06/19
        public static bool W_ScanOn;
        ...
        public static void SetFixedVariable()
        {
            ...
            */
            ...
            // X線切替(外部制御有)(高速透視優先)　//外部制御OFFの場合は、従来のX線切替機能 v23.10 by長野 2015/09/18
            ChangeXrayOn = (scaninh.Data.multi_tube == 0 && scaninh.Data.xray_remote == 0) && !HscOn;
            ...
            W_ScanOn = (CTSettings.scaninh.Data.w_scan == 0);//Wスキャン
            ...
            */
            ...
            GVal_LargeTableRingWidth = CTSettings.mechapara.Data.largeTableRingWidth;

            // 検出器側に最も寄せた時の検出器とテーブルの間隔 by長野 2016/02/23
            Gval_BetMaxFcdAndFdd = CTSettings.mechapara.Data.max_fdd - CTSettings.mechapara.Data.max_fcd;
            ...
            //Rev23.10 ソフト起動時は、scanselの値に従いX線制御器のタイプを設定
            if (scaninh.Data.multi_tube == 1)
            {
            ...
            else
            {
                ...
                if (CTSettings.scansel.Data.multi_tube == 0)
                {
                    modXrayControl.XrayType = (modXrayControl.XrayTypeConstants)Convert.ToInt32(t20kinf.Data.system_type.GetString());
                }
                else
                {
                    modXrayControl.XrayType = (modXrayControl.XrayTypeConstants)Convert.ToInt32(t20kinf.Data.system_type2.GetString());
                }
            }
