...
#region		//v29.99 今のところ不要 by長野 2013/04/08'''''ここから'''''
            ...
            //Rev23.40 by長野 2016/04/05 / Rev23.21 高速カメラ用に復活
            CTSettings.hscpara = new HscPara();
            if (!CTSettings.hscpara.Load())
            {
        ...
        public static void Cal_SaveImageSize()
        {
            ...
            long PurRawFile = 0;    //純生ﾃﾞｰﾀﾌｧｲﾙｻｲｽﾞ                       'Rev23.10 2015/12/28 by長野 
...
#region		//v29.99 今のところ不要 by長野 2013/04/08'''''ここから'''''
            ...
            switch (CTSettings.scansel.Data.data_mode)
            {
                ...
                case (int)ScanSel.DataModeConstants.DataModeCone:
                    ...
                    if (TableRotOn)     //v16.2 追加 by 山影 2010/01/19
                    {
                        ...
                        //Rev20.00 1次元幾何歪は行わないため不要 by長野 2014/11/10
                        //else
                        //{
                        ...
                        //Rev23.10 変更 by長野 2015/10/26
                        //CTAPI.CTLib.cone_setup_iicrct(ref the_ic, ref the_jc, ref the_theta_s, ref the_dpm, ref nstart, ref nend, ref mstart, ref mend, ref the_delta_theta,
                        //     ref the_n0, ref the_m0, ref delta_im, ref delta_jm, ref ir0, ref jr0, ref kix, ref kjx,
                        //     //CTSettings.scancondpar.Data.b[1], CTSettings.scancondpar.Data.scan_posi_a[2], CTSettings.scancondpar.Data.scan_posi_b[2],
                        //     CTSettings.scancondpar.Data.b[1], CTSettings.scancondpar.Data.scan_posi_a[2], modScanCondition.real_scan_posi_b,//Rev23.20 引数変更 by長野 2015/11/19
                        //     CTSettings.scancondpar.Data.fimage_hsize, CTSettings.scancondpar.Data.fimage_vsize,
                        //     CTSettings.scansel.Data.fid, tmp_h_size, 2 * Val_Mc + 1, Val_Mc,
                        //     ref ScanCorrect.hizumi[0], ref js, ref je, ref delta_ix, ref delta_jx, CTSettings.detectorParam.hm, CTSettings.detectorParam.vm, 0, CTSettings.scaninh.Data.full_distortion,
                        //     CTSettings.scancondpar.Data.ist, CTSettings.scancondpar.Data.ied, CTSettings.scancondpar.Data.detector,
                        //     CTSettings.scansel.Data.scan_mode);	//v17.00 引数detector追加 byやまおか 2010/02/26 v19.41とv18.02の統合 by長野 2013/11/12
                        ...
                        CTAPI.CTLib.cone_setup_iicrct(ref the_ic, ref the_jc, ref the_theta_s, ref the_dpm, ref nstart, ref nend, ref mstart, ref mend, ref the_delta_theta,
                             ...
                             ref ScanCorrect.hizumi[0], ref js, ref je, ref delta_ix, ref delta_jx, CTSettings.detectorParam.hm, CTSettings.detectorParam.vm, 0, CTSettings.scaninh.Data.full_distortion,
                             CTSettings.scancondpar.Data.ist, CTSettings.scancondpar.Data.ied, CTSettings.scancondpar.Data.detector,
                             CTSettings.scansel.Data.scan_mode,lr_sft_mode,CTSettings.scancondpar.Data.det_sft_pix_r,CTSettings.scancondpar.Data.det_sft_pix_l);//v23.20 引数追加 by長野 2016/01/22


                        //Rev20.00 modScanConditionもここで更新 by長野 2014/12/15
                        ...
                        //RawFile = (2 * Val_Mc + 1) * h * DataView * 2 + (je - js + 1) * h * DataView * 2;					//v16.2 オーバーフロー対策 by山影 2010/01/19
                        //Rev20.00 修正 by長野 2015/04/10
                        RawFile = (long)(2 * Val_Mc + 1) * (long)(h * DataView * 2) + (long)((je - js + 1) * h * DataView * 2);					//v16.2 オーバーフロー対策 by山影 2010/01/19
                    }
                    else
                    {
                        ...
                        //RawFile = (2 * Val_Mc + 1) * h * DataView * 2;						//changed by 山本　2004-10-22　nd->h ビニング後のサイズにするため
                        //Rev20.00 修正 by長野 2015/04/10
                        RawFile = (long)(2 * Val_Mc + 1) * (long)(h * DataView * 2);						//changed by 山本　2004-10-22　nd->h ビニング後のサイズにするため

                    }
                    break;
            }

            //Rev23.12 純生データ保存の場合を追加 by長野 2015/12/28--->
            if (CTSettings.scansel.Data.pur_rawdata_save == 1)
            {
                ...
                {
                    tmp_h_size = CTSettings.scancondpar.Data.fimage_hsize + CTSettings.scancondpar.Data.det_sft_pix;
                    PurRawFile = (long)(Convert.ToDouble(CTSettings.scancondpar.Data.mainch[0]) * tmp_h_size * Convert.ToDouble(DataView) * 2.0 * 2.0);
                }
                else
                {
                    tmp_h_size = CTSettings.scancondpar.Data.fimage_hsize;
                    PurRawFile = (long)(Convert.ToDouble(CTSettings.scancondpar.Data.mainch[0]) * tmp_h_size * Convert.ToDouble(DataView) * 2.0);
                }
            }
            //<---
...
*/
            ...
            if ((CTSettings.scansel.Data.rawdata_save == 1) || (CTSettings.scansel.Data.pur_rawdata_save == 1) || //Rev23.12 純生ﾃﾞｰﾀ保存フラグ追加 by長野 2015/12/28
                (CTSettings.scansel.Data.data_mode == (int)ScanSel.DataModeConstants.DataModeCone))
            {
                ...
                //}                                                                                             //v11.5追加 by 間々田 2006-06-28				
                //Rev23.12 条件変更 by長野 2015/12/28 --->
                if (CTSettings.scansel.Data.rawdata_save == 0 && CTSettings.scansel.Data.pur_rawdata_save == 0)
                {
                    if (CTSettings.scansel.Data.data_mode == (int)ScanSel.DataModeConstants.DataModeCone)
                    {
                        ScanImageSize = ScanImageSize + (double)(RawFile * cnt_slice * cnt_multi) / 1024 / 1024;	//MB単位
                ...
                else if (CTSettings.scansel.Data.rawdata_save == 1 && CTSettings.scansel.Data.pur_rawdata_save == 0)
                {                                                                                               //v11.5追加 by 間々田 2006-06-28
                    ScanImageSize = ScanImageSize + (double)(RawFile * cnt_slice * cnt_multi) / 1024 / 1024;	//MB単位
                }
                else
                {
                    ScanImageSize = ScanImageSize + (double)(RawFile * cnt_slice * cnt_multi) / 1024 / 1024 + (double)(PurRawFile * cnt_slice) / 1024 / 1024;	//MB単位
                }
                //<---
            }
            else
...
#region		//v29.99 今のところ不要 by長野 2013/04/08'''''ここから'''''
            ...
            //Rev25.00 Wスキャンが有効状態で、シフトスキャンや左右シフトが生きている場合はエラー終了 by長野 2016/07/07
            if(CTSettings.scaninh.Data.w_scan == 0 && (CTSettings.scaninh.Data.lr_sft == 0 || CTSettings.scaninh.Data.scan_mode[3] == 0))
            {
                MessageBox.Show(Application.ProductName, CTResources.LoadResString(StringTable.IDS_W_ScanConflictScanInhibit), MessageBoxButtons.OK, MessageBoxIcon.Error);
                System.Environment.Exit(0);
            }
            //Rev26.00 ファントムレスBHCと従来BHCの両方が有効状態の場合はエラー終了 by井上 2017/01/16
            if (CTSettings.scaninh.Data.mbhc == 0 && CTSettings.scaninh.Data.mbhc_phantomless == 0)
            {
                MessageBox.Show(CTResources.LoadResString(StringTable.IDS_BHCConflict), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error);
                System.Environment.Exit(0);
            }
            ...
            //Rev26.00 BHC材質リスト用ファイルが存在しない場合処理をやめる by井上 2017/04/05      
            if (CTSettings.scaninh.Data.mbhc_phantomless == 0)
            {
                if (!File.Exists(CTSettings.iniValue.BHCMaterialListFileName))
                {
                    //MsgBox "以下のファイルが見つかりません。ＣＴ３０Ｋを終了します。" & vbCr & vbCr & XisIniFileName, vbCritical

                    string msg = string.Format("{0}\n\n{1}", CTResources.LoadResString(20181), CTSettings.iniValue.BHCMaterialListFileName);
                    MessageBox.Show(msg, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    Environment.Exit(0);
                }
            }
            ...
            //Rev23.20 子フォームでエラーする場合でも、一旦ロード完了させる。
            //エラーの場合でも、Loadイベント途中で自分自身をCloseさせない。例外が出る。
            //エラーしている場合は、ここで終了させる。(今のところX線だけフラグを入れているが、他に入れる場合はここに追加) by長野 2016/01/19
            //if (frmXrayControl.Instance.XrayControlStartSuccessAtFLoad == false)
            //Rev23.40 変更 by長野 2016/06/19 
            if (frmXrayControl.Instance.XrayControlStartSuccessAtFLoad == false && CTSettings.scaninh.Data.xray_remote == 0)
            {
                _frmCTMenu.Close();
            }

            //追加2015/02/10hata
            //ＣＴメインメニューが起動してないときはここで終了する
            //何らかのエラーが発生している
            if (!modLibrary.IsExistForm("frmCTMenu"))
            {
                Environment.Exit(0);
                return;
            }
            ...
            //frmScanControl.Instance.optScanMode[1].Enabled = (CTSettings.scaninh.Data.scan_mode[0] == 0);            //ハーフ
            //frmScanControl.Instance.optScanMode[2].Enabled = (CTSettings.scaninh.Data.scan_mode[1] == 0);            //フル
            //frmScanControl.Instance.optScanMode[3].Enabled = (CTSettings.scaninh.Data.scan_mode[2] == 0);            //オフセット
            //frmScanControl.Instance.optScanMode[4].Enabled = (CTSettings.scaninh.Data.scan_mode[3] == 0);            //シフトオフセット

            //frmScanControl.Instance.optScanMode[1].Visible = (CTSettings.scaninh.Data.scan_mode[0] == 0);            //ハーフ
            //frmScanControl.Instance.optScanMode[2].Visible = (CTSettings.scaninh.Data.scan_mode[1] == 0);            //フル
            //frmScanControl.Instance.optScanMode[3].Visible = (CTSettings.scaninh.Data.scan_mode[2] == 0);            //オフセット
            //frmScanControl.Instance.optScanMode[4].Visible = (CTSettings.scaninh.Data.scan_mode[3] == 0);            //シフトオフセット
            ...
            //Rev23.40 by長野 2016/04/05 / Rev23.21 高速度カメラ機能ONの場合、初期化を行っておく(表示しないが中の処理を使用するため)
            if (CTSettings.scaninh.Data.high_speed_camera == 0)
            {
                frmXrayWarning.Instance.Init();
            }
            ...
            //Rev20.00 この後に実行するfrmXrayControl.Instance.QueryWarmupを実行させるために、ここに移動 by長野 2014/11/10
            //追加2014/10/28hata
            CT30KSetup = true; //起動完了

            //Rev23.40 by長野 2016/04/05 //Rev23.20 by長野 2016/02/22
            modMechaControl.Flg_SeqCommUpdate = true;
            modMechaControl.Flg_MechaControlUpdate = true;

            //Rev23.40 by長野 2016/04/05 //Rev23.21 ここに移動 //起動時のCT/高速撮影の判定 v16.01 追加 by 山影 10-02-04
            Application.DoEvents();
            //modHighSpeedCamera.HscStartUpProcess();
            //Rev23.40 変更 by長野 2016/05/25
            if (CTSettings.scaninh.Data.seqcomm == 0)
            {
                modHighSpeedCamera.HscStartUpProcess();
            }

            //Rev23.10 全フォームの表示・初期設定完了後に、X線切替用の初期設定を行う。
            if (CTSettings.ChangeXrayOn) ///Rev23.10 追加 by長野 2015/10/06
            {
                mod2ndXray.SecondXrayStartUpProcess();
            }
            ...
            //Rev25.00 不要のためコメントアウト by長野 2016/07/05
            ////if (CTSettings.scaninh.Data.avmode == 0)
            ////Rev25.00 Wスキャンを条件に追加
            //if (CTSettings.scaninh.Data.avmode == 0 || CTSettings.scaninh.Data.sftMode == 0)
            //{
            //    ////追加2014/10/07hata_v19.51反映
            //    ////'スキャンモードオプションボタンの表示と位置調整(InitControl内だと失敗するのでここで実行)
            //    frmScanControl.Instance.optScanMode[1].Enabled = (CTSettings.scaninh.Data.scan_mode[0] == 0);            //ハーフ
            ...
            //    if(CTSettings.scaninh.Data.sftMode == 0)
            //    {
            //        frmScanControl.Instance.optScanMode[4].Visible = false;
            //        frmScanControl.Instance.chkSftMode.Visible = true;
            //        frmScanControl.Instance.chkSftMode.Location = new Point(frmScanControl.Instance.optScanMode[1].Left, frmScanControl.Instance.optScanMode[1].Top);
            ...
            if (CTSettings.scaninh.Data.xray_remote == 0 &&
               (modXrayControl.XrayType == modXrayControl.XrayTypeConstants.XrayTypeHamaL9181_02) ||
               modXrayControl.XrayType == modXrayControl.XrayTypeConstants.XrayTypeHamaL10711) //Rev23.10 追加 by長野 2015/10/18
            {
            ...
            {
                modSeqComm.ct_gene2and3LimitControl(modSeqComm.MySeq.stsFDSystemPos);
            }
...
#region //v29.99 今のところ不要 by長野 2013/04/08'''''ここから'''''
        ...
        public static string GetXrayStr(int Index)
        {
            ...
            //Rev23.10 変更 by長野 2015/10/16
            if (CTSettings.infdef.Data.multi_tube.GetLowerBound(0) <= Index && CTSettings.infdef.Data.multi_tube.GetUpperBound(0) >= Index)
            {
        ...
        public static string GetFpdGainStr(int Mode,int fpd_type)//Rev26.00 change by chouno 2017/04/21
        {
            string functionReturnValue = null;
...
//#if !NoCamera    //v17.48/v17.53デバグ用 byやまおか
        ...
        public static string GetFpdIntegStr(int Mode)
        {
            ...
            {
                //Rev20.00 -0.5は不要 by長野 2014/11/10
        ...
        public static void GetBinning()
        {
            ...
            ScanCorrect.GAIN_CORRECT_SFT_R = ScanCorrect.CORRECT_PATH + "GainSR" + CTSettings.scansel.Data.binning.ToString() + ".cor";  //'ゲイン(右シフト用)
            ScanCorrect.GAIN_CORRECT_SFT_L = ScanCorrect.CORRECT_PATH + "GainSL" + CTSettings.scansel.Data.binning.ToString() + ".cor";  //'ゲイン(左シフト用)
            ...
            //Rev23.20 左右シフト対応 by長野 2015/11/19
            ScanCorrect.GAIN_CORRECT_L_SFT_R = ScanCorrect.CORRECT_PATH + "GainLSR" + CTSettings.scansel.Data.binning.ToString() + ".cor";     //'ゲイン(LONG型用)(右シフト用)
            ScanCorrect.GAIN_CORRECT_L_SFT_L = ScanCorrect.CORRECT_PATH + "GainLSL" + CTSettings.scansel.Data.binning.ToString() + ".cor";     //'ゲイン(LONG型用)(左シフト用)
            ...
            ScanCorrect.GAIN_CORRECT_AIR_SFT_R = ScanCorrect.CORRECT_PATH + "Gain_air_R.cor";
            ScanCorrect.GAIN_CORRECT_AIR_SFT_L = ScanCorrect.CORRECT_PATH + "Gain_air_L.cor";
            ...
            CTSettings.detectorParam.Gain_Correct_Sft_R_File = ScanCorrect.GAIN_CORRECT_SFT_R;
            CTSettings.detectorParam.Gain_Correct_Sft_L_File = ScanCorrect.GAIN_CORRECT_SFT_L;
            ...
            //Rev23.20 左右シフト対応 by長野 2015/11/19
            CTSettings.detectorParam.Gain_Correct_L_Sft_R_File = ScanCorrect.GAIN_CORRECT_L_SFT_R;
            CTSettings.detectorParam.Gain_Correct_L_Sft_L_File = ScanCorrect.GAIN_CORRECT_L_SFT_L;
...
*/
        ...
        //   テキストボックスバイト数チェック（全角文字対応版）              '新規作成 2003/11/19 by 間々田
        //
        public static void ChangeTextBoxNoMessageBox(TextBox theTextBox)
        {
            #region CT30Kv19.13_64bit 化不要コメントアウト_完全版
            /*
            Dim ansiStr     As String
...
#region //v15.0削除ここから by 間々田 2006/03/16
        ...
        //
        //  指定したモジュールの強制終了 //Rev26.00 add by chouno 2017/03/13
        //
        public static void KillProcess(string Process)
        {
            System.Diagnostics.Process[] ps = System.Diagnostics.Process.GetProcessesByName(AppValue.RECIUDP);
            foreach (Process p in ps)
            {
                p.Kill();
            }
        ...
        public static void InitGlobalVariables()        //v17.20 検出器切替改造のためpublic化 by 長野 2010-09-01
        {
            ...
            ScanCorrect.GVal_DistValMeasure[1] = 10.0F;		//v23.12 追加 by長野 2015/12/11
            ScanCorrect.GVal_DistValMeasure[2] = 10.0F;		//v23.12 追加 by長野 2015/12/11
            ...
            //Rev26.00 BHC材質リスト用ファイル初期化 by井上 2017/04/05
            modBHC.InitBHCMaterialList(CTSettings.iniValue.BHCMaterialListFileName);
        }
...
#region		//v29.99 今のところ不要 by長野 2013/04/08'''''ここから'''''
            ...
            if (strCommand == AppValue.SCANAV || strCommand == AppValue.CONEBEAM || strCommand == AppValue.SCANOAV)
            {
            ...
            if (modLibrary.IsExistForm("frmMechaControl"))  //OpenしていないとLoadしてしまうため　2014/06/05(検S1)hata
            {
                ...
                //タッチパネル操作禁止
                modSeqComm.SeqBitWrite("PanelInhibit", true);   //Rev20.00 追加 by稲葉 2015/03/05
            }
...
#region		//v29.99 今のところ不要 by長野 2013/04/08'''''ここから'''''
            ...
            if (modLibrary.IsExistForm("frmMechaControl"))  //OpenしていないとLoadしてしまうため　2014/06/05(検S1)hata
            {
                ...
                //タッチパネル操作を許可
                modSeqComm.SeqBitWrite("PanelInhibit", false);   //Rev20.00 追加 by稲葉 2015/03/05
            }
...
#region		//v29.99 今のところ不要 by長野 2013/04/08'''''ここから'''''
            ...
            {
                //再構成フォームのアンロード
                frmRetryCondition.Instance.Close(); //復活2015/02/05disposeだけでは、Close処理を通らない。
                //Rev20.00 showDialogで開いているためdispose by長野 2014/12/15
