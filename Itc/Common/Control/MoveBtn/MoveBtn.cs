...
namespace Itc.Common.Controls.MoveBtn
{
    ...
    public partial class MoveBtn : Button
    {
        /// <summary>
        /// 移動のイベント
        /// </summary>
        public event ChkChangeEventHandler MoveStateCtrl;
        /// <summary>
        /// 制限によって色を変更する
        /// </summary>
        ...
        {
            MoveStateCtrl?.Invoke(this, new ChkChangeEventArgs(false));
        }
        /// <summary>
        /// マウスダウン時（MoveStop）
        /// </summary>
        ...
        {
            MoveStateCtrl?.Invoke(this, new ChkChangeEventArgs(true));
        }
        /// <summary>
        /// マウスダウン時（MoveStop）
        /// </summary>
        /// <param name="mevent"></param>
        //protected override void On(MouseEventArgs mevent)
        //{
        //    MoveStateCtrl?.Invoke(this, new ChkChangeEventArgs(true));
        //}
    }
