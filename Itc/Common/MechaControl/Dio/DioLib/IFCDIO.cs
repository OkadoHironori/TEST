...
namespace InterfaceCorpDllWrap
{
	public class IFCDIO_ANY
	{
        ...
        #region Symbols and/or identifiers
        // -----------------------------------------------------------------------
        ...
        //上記コメントをそのまま出力
        /// <summary>
        /// 戻り値をエラーメッセージに変換 (ITC追加)
        /// </summary>
        /// <param name="sts">エラーコード</param>
        /// <returns>メッセージ</returns>
        public static string GetErrorMessage(uint sts)
        {
            switch (sts)
            {
                case IFCDIO_ANY.FBIDIO_ERROR_SUCCESS:
                    return DioLib.Properties.Resources.ERROR_SUCCESS;

                case IFCDIO_ANY.FBIDIO_ERROR_NOT_DEVICE:
                    return DioLib.Properties.Resources.ERROR_NOT_DEVICE;

                case IFCDIO_ANY.FBIDIO_ERROR_NOT_OPEN:
                    return DioLib.Properties.Resources.ERROR_NOT_OPEN;
                
                case IFCDIO_ANY.FBIDIO_ERROR_INVALID_HANDLE:
                    return DioLib.Properties.Resources.ERROR_INVALID_HANDLE;
                
                case IFCDIO_ANY.FBIDIO_ERROR_ALREADY_OPEN:
                    return DioLib.Properties.Resources.ERROR_ALREADY_OPEN;
                
                case IFCDIO_ANY.FBIDIO_ERROR_HANDLE_EOF:
                    return DioLib.Properties.Resources.ERROR_HANDLE_EOF;
                
                case IFCDIO_ANY.FBIDIO_ERROR_MORE_DATA:
                    return DioLib.Properties.Resources.ERROR_MORE_DATA;
                
                case IFCDIO_ANY.FBIDIO_ERROR_INSUFFICIENT_BUFFER:
                    return DioLib.Properties.Resources.ERROR_INSUFFICIENT_BUFFER;
                
                case IFCDIO_ANY.FBIDIO_ERROR_IO_PENDING:
                    return DioLib.Properties.Resources.ERROR_IO_PENDING;
                
                case IFCDIO_ANY.FBIDIO_ERROR_NOT_SUPPORTED:
                    return DioLib.Properties.Resources.ERROR_NOT_SUPPORTED;
                
                case IFCDIO_ANY.FBIDIO_ERROR_MEMORY_NOTALLOCATED:
                    return DioLib.Properties.Resources.ERROR_MEMORY_NOTALLOCATED;
                
                case IFCDIO_ANY.FBIDIO_ERROR_PARAMETER:
                    return DioLib.Properties.Resources.ERROR_PARAMETER;
                
                case IFCDIO_ANY.FBIDIO_ERROR_INVALID_CALL:
                    return DioLib.Properties.Resources.ERROR_INVALID_CALL;
                
                case IFCDIO_ANY.FBIDIO_ERROR_DRVCAL:
                    return DioLib.Properties.Resources.ERROR_DRVCAL;
                
                case IFCDIO_ANY.FBIDIO_ERROR_NULL_POINTER:
                    return DioLib.Properties.Resources.ERROR_NULL_POINTER;
                
                case IFCDIO_ANY.FBIDIO_ERROR_IO_INCOMPLETE:
                    return DioLib.Properties.Resources.ERROR_IO_INCOMPLETE;
                
                case IFCDIO_ANY.FBIDIO_ERROR_UNSAFE_USE:
                    return DioLib.Properties.Resources.ERROR_UNSAFE_USE;
                
                default:
                    return string.Format(DioLib.Properties.Resources.ERROR_UNKNOWN, sts);
            }
        }
