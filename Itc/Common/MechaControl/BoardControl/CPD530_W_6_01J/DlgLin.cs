...
namespace spc53004
{
	...
	/// DlgLin の概要の説明です。
	/// </summary>
	public class DlgLin : System.Windows.Forms.Form
	{
		public System.Windows.Forms.Label LblYerr;
		public System.Windows.Forms.TextBox TxtYdstnc;
		...
		private void InitializeComponent()
		{
			...
			this.TxtYdstnc = new System.Windows.Forms.TextBox();
			...
			this.PnlYEls.SuspendLayout();
			this.PnlYAlm.SuspendLayout();
			this.PnlYSvon.SuspendLayout();
			this.FraXax.SuspendLayout();
			this.PnlXSvon.SuspendLayout();
			this.PnlXAlm.SuspendLayout();
			this.PnlXEls.SuspendLayout();
			this.SuspendLayout();
			// 
			// LblYerr
			// 
			...
			this.LblYerr.Location = new System.Drawing.Point(12, 352);
			this.LblYerr.Name = "LblYerr";
			this.LblYerr.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.LblYerr.Size = new System.Drawing.Size(184, 25);
			this.LblYerr.TabIndex = 97;
			// 
			// TxtYdstnc
			// 
			this.TxtYdstnc.AcceptsReturn = true;
			this.TxtYdstnc.AutoSize = false;
			this.TxtYdstnc.BackColor = System.Drawing.SystemColors.Window;
			this.TxtYdstnc.Cursor = System.Windows.Forms.Cursors.IBeam;
			this.TxtYdstnc.ForeColor = System.Drawing.SystemColors.WindowText;
			this.TxtYdstnc.Location = new System.Drawing.Point(12, 152);
			this.TxtYdstnc.MaxLength = 10;
			this.TxtYdstnc.Multiline = true;
			this.TxtYdstnc.Name = "TxtYdstnc";
			this.TxtYdstnc.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.TxtYdstnc.Size = new System.Drawing.Size(137, 22);
			this.TxtYdstnc.TabIndex = 93;
			this.TxtYdstnc.Text = "";
			this.TxtYdstnc.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// TxtFH
			// 
			...
			this.TxtFH.Location = new System.Drawing.Point(12, 240);
			...
			this.TxtFH.Size = new System.Drawing.Size(137, 22);
			...
			this.BtnStp.Location = new System.Drawing.Point(12, 48);
			...
			this.BtnLine.Location = new System.Drawing.Point(12, 16);
			this.BtnLine.Name = "BtnLine";
			this.BtnLine.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.BtnLine.Size = new System.Drawing.Size(137, 25);
			this.BtnLine.TabIndex = 83;
			this.BtnLine.Text = "直線補間";
			...
			this.TxtXdstnc.Location = new System.Drawing.Point(12, 112);
			...
			this.TxtXdstnc.Size = new System.Drawing.Size(137, 22);
			this.TxtXdstnc.TabIndex = 87;
			this.TxtXdstnc.Text = "";
			...
			this.FraYax.Controls.Add(this.PnlYEls);
			this.FraYax.Controls.Add(this.PnlYAlm);
			this.FraYax.Controls.Add(this.PnlYSvon);
			...
			this.FraYax.Controls.Add(this.Label3);
			this.FraYax.ForeColor = System.Drawing.SystemColors.ControlText;
			this.FraYax.Location = new System.Drawing.Point(356, 8);
			...
			this.LblYpos.TabIndex = 30;
			this.LblYpos.Text = "0";
			this.LblYpos.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// PnlYEls
			// 
			this.PnlYEls.BackColor = System.Drawing.SystemColors.Control;
			this.PnlYEls.Controls.Add(this.OptYels0);
			this.PnlYEls.Controls.Add(this.OptYels1);
			this.PnlYEls.Cursor = System.Windows.Forms.Cursors.Default;
			this.PnlYEls.ForeColor = System.Drawing.SystemColors.ControlText;
			this.PnlYEls.Location = new System.Drawing.Point(88, 24);
			this.PnlYEls.Name = "PnlYEls";
			this.PnlYEls.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.PnlYEls.Size = new System.Drawing.Size(89, 25);
			this.PnlYEls.TabIndex = 27;
			this.PnlYEls.Text = "Frame2";
			// 
			// OptYels0
			// 
			...
			// PnlYAlm
			// 
			this.PnlYAlm.BackColor = System.Drawing.SystemColors.Control;
			this.PnlYAlm.Controls.Add(this.OptYalm0);
			this.PnlYAlm.Controls.Add(this.OptYalm1);
			this.PnlYAlm.Cursor = System.Windows.Forms.Cursors.Default;
			this.PnlYAlm.ForeColor = System.Drawing.SystemColors.ControlText;
			this.PnlYAlm.Location = new System.Drawing.Point(88, 88);
			this.PnlYAlm.Name = "PnlYAlm";
			this.PnlYAlm.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.PnlYAlm.Size = new System.Drawing.Size(89, 25);
			this.PnlYAlm.TabIndex = 24;
			this.PnlYAlm.Text = "Frame2";
			// 
			// OptYalm0
			// 
			...
			// PnlYSvon
			// 
			this.PnlYSvon.BackColor = System.Drawing.SystemColors.Control;
			this.PnlYSvon.Controls.Add(this.OptYsvon0);
			this.PnlYSvon.Controls.Add(this.OptYsvon1);
			this.PnlYSvon.Cursor = System.Windows.Forms.Cursors.Default;
			this.PnlYSvon.ForeColor = System.Drawing.SystemColors.ControlText;
			this.PnlYSvon.Location = new System.Drawing.Point(88, 184);
			this.PnlYSvon.Name = "PnlYSvon";
			this.PnlYSvon.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.PnlYSvon.Size = new System.Drawing.Size(89, 25);
			this.PnlYSvon.TabIndex = 21;
			this.PnlYSvon.Text = "Frame2";
			// 
			// OptYsvon0
			// 
			...
			this.FraXax.Controls.Add(this.PnlXSvon);
			this.FraXax.Controls.Add(this.PnlXAlm);
			this.FraXax.Controls.Add(this.PnlXEls);
			this.FraXax.Controls.Add(this.LblXpos);
			this.FraXax.Controls.Add(this.Label2);
			...
			this.FraXax.Location = new System.Drawing.Point(164, 8);
			...
			this.FraXax.TabIndex = 85;
			this.FraXax.TabStop = false;
			this.FraXax.Text = "X軸";
			// 
			// PnlXSvon
			// 
			this.PnlXSvon.BackColor = System.Drawing.SystemColors.Control;
			this.PnlXSvon.Controls.Add(this.OptXsvon1);
			this.PnlXSvon.Controls.Add(this.OptXsvon0);
			this.PnlXSvon.Cursor = System.Windows.Forms.Cursors.Default;
			this.PnlXSvon.ForeColor = System.Drawing.SystemColors.ControlText;
			this.PnlXSvon.Location = new System.Drawing.Point(88, 184);
			this.PnlXSvon.Name = "PnlXSvon";
			this.PnlXSvon.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.PnlXSvon.Size = new System.Drawing.Size(89, 25);
			this.PnlXSvon.TabIndex = 7;
			this.PnlXSvon.Text = "Frame2";
			// 
			// OptXsvon1
			// 
			...
			// PnlXAlm
			// 
			this.PnlXAlm.BackColor = System.Drawing.SystemColors.Control;
			this.PnlXAlm.Controls.Add(this.OptXalm1);
			this.PnlXAlm.Controls.Add(this.OptXalm0);
			this.PnlXAlm.Cursor = System.Windows.Forms.Cursors.Default;
			this.PnlXAlm.ForeColor = System.Drawing.SystemColors.ControlText;
			this.PnlXAlm.Location = new System.Drawing.Point(88, 88);
			this.PnlXAlm.Name = "PnlXAlm";
			this.PnlXAlm.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.PnlXAlm.Size = new System.Drawing.Size(89, 25);
			this.PnlXAlm.TabIndex = 4;
			this.PnlXAlm.Text = "Frame2";
			// 
			// OptXalm1
			// 
			...
			// PnlXEls
			// 
			this.PnlXEls.BackColor = System.Drawing.SystemColors.Control;
			this.PnlXEls.Controls.Add(this.OptXels1);
			this.PnlXEls.Controls.Add(this.OptXels0);
			this.PnlXEls.Cursor = System.Windows.Forms.Cursors.Default;
			this.PnlXEls.ForeColor = System.Drawing.SystemColors.ControlText;
			this.PnlXEls.Location = new System.Drawing.Point(88, 24);
			this.PnlXEls.Name = "PnlXEls";
			this.PnlXEls.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.PnlXEls.Size = new System.Drawing.Size(89, 25);
			this.PnlXEls.TabIndex = 1;
			this.PnlXEls.Text = "Frame2";
			// 
			// OptXels1
			// 
			...
			this.LblXspd.Location = new System.Drawing.Point(428, 288);
			...
			this.Label6.Location = new System.Drawing.Point(364, 288);
			this.Label6.Name = "Label6";
			this.Label6.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.Label6.Size = new System.Drawing.Size(54, 15);
			this.Label6.TabIndex = 95;
			this.Label6.Text = "合成速度";
			// 
			// Label5
			// 
			...
			this.LblXint.Location = new System.Drawing.Point(12, 288);
			...
			this.LblXerr.Location = new System.Drawing.Point(12, 320);
			...
			this.Controls.Add(this.TxtYdstnc);
			...
			this.Name = "DlgLin";
			this.Text = "ＸＹ軸直線補間動作";
			this.Load += new System.EventHandler(this.DlgLin_Load);
			this.Closed += new System.EventHandler(this.DlgLin_Closed);
			this.FraYax.ResumeLayout(false);
			this.PnlYEls.ResumeLayout(false);
			this.PnlYAlm.ResumeLayout(false);
			this.PnlYSvon.ResumeLayout(false);
			this.FraXax.ResumeLayout(false);
			this.PnlXSvon.ResumeLayout(false);
			this.PnlXAlm.ResumeLayout(false);
			this.PnlXEls.ResumeLayout(false);
		...
		// フォームが閉じようとする時の処理
		private void DlgLin_Closed(object sender, System.EventArgs e)
		{
		...
		// フォームロード処理
		private void DlgLin_Load(object sender, System.EventArgs e)
		{
			uint unRet = 0;
			uint hDev = spc53004Class.hDeviceID;
			string s;
		...
		private void BtnLine_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				lEnd1 = int.Parse(TxtXdstnc.Text);
				lEnd2 = int.Parse(TxtYdstnc.Text);
			}
			catch
			{
			...
			// Ｘ軸終点設定
			unRet = Cp530l1a.hcp530_WritLine(hDev, 0, lEnd1);
			if (0 == unRet)
			{
				// Ｙ軸終点設定
				unRet = Cp530l1a.hcp530_WritLine(hDev, 1, lEnd2);
				if (0 == unRet)
				{
					// Ｘ軸動作モード設定(直線補間動作)
					unRet = Cp530l1a.hcp530_WritOpeMode(hDev, 0, 0x61);
					if (0 == unRet)
					{
						// Ｙ軸動作モード設定(直線補間動作)
						unRet = Cp530l1a.hcp530_WritOpeMode(hDev, 1, 0x61);
						if (0 == unRet)
						{
							// 加速スタート(X-Y軸)
							unRet = Cp530l1a.hcp530_AccStart(hDev, 3);
							if (0 == unRet)
							{
								// コントロール表示等
		...
		private void BtnStp_Click(object sender, System.EventArgs e)
		{
			...
			unRet = Cp530l1a.hcp530_DecStop(hDev, 3);
			if (0 != unRet)
			{
				s = "エラーが発生しました!\r\n戻り値：" + unRet.ToString("X8");
				MessageBox.Show(s);
