...
namespace TXSMechaControl.FCD
{
    ...
    public interface IFCD
    {
        ...
        /// 原点復帰
        /// </summary>
        bool Origin(Action<string> mes, IProgress<CalProgress> prog, CancellationToken ctoken);
        /// <summary>
        /// 手動動作
        /// </summary>
        ...
        /// <returns></returns>
        bool Index(float posi, Action<string> mes, IProgress<CalProgress> prog, CancellationToken ctoken);
        /// <summary>
        /// 停止
        /// </summary>
        /// <returns></returns>
